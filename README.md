...
1. Run een commando om de Python dependencies te installeren: ```pip install -r requirements.txt``` (Op Windows kan je tegen probleem aanlopen dat path te lang wordt: [link](https://docs.python.org/3.7/using/windows.html#removing-the-max-path-limitation))
